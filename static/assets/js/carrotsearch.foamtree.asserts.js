 ...
 * under the License.
 *
 * Copyright 2002-2026, Carrot Search s.c, All Rights Reserved.
 *
 *
...
(function() {
  ...
  var optionDefinitions = function() {
    ...
    ([
      ...
      "onRelaxationStep", "onRedraw", "onViewReset", "onViewResetting",
    ...
    ([
      ...
      args[key].since = "3.5.3";
    });

    ([
      "onViewResetting"
    ]).forEach(function(key) {
      args[key].since = "3.5.6";
    });
 ...
 * Build version : 3.6.1
 * Build number  : [unset]
 * Build time    : Apr 09, 2026
 * Built by      : runner
 * Build revision: master/a7be23a4
 */